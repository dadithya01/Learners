...
import edu.ijse.learners.dto.tm.InstructorTM;
...
public class InstructorManagePageController implements Initializable {
    ...
    public void btnAddOnAction(ActionEvent actionEvent) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/view/InstructorManagePOPupPage.fxml"));
    ...
    public void onUpdate(InstructorDTO instructorDTO) {
        try {
            ...
            InstructorPOPupPageController controller = fxmlLoader.getController();
