...
//    private Timeline timeline;
    ...
    public void init(Runnable run, String title) {
        ...
        if (run != null) {
            Image image = new Image(BackController.class.getResource("/assets/pictures/arrow-right.jpg").toExternalForm());
            ...
            Image image = new Image(BackController.class.getResource("/assets/pictures/home.jpg").toExternalForm());
            ImageView icon = new ImageView(image);
            icon.setFitWidth(15);
            icon.setFitHeight(15);
            icon.setNodeOrientation(NodeOrientation.RIGHT_TO_LEFT);
