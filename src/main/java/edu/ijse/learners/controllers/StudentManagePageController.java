...
import edu.ijse.learners.dto.tm.StudentTM;
...
public class StudentManagePageController implements Initializable {
    ...
    public void btnAddOnAction(ActionEvent actionEvent) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/view/StudentManagePopupPage.fxml"));
    ...
    public void onUpdate(StudentDTO studentDTO) {
        try {
            ...
            StudentPopUpPageController controller = fxmlLoader.getController();
