...
import edu.ijse.learners.dto.tm.CourseTM;
...
public class CourseManegePageController  implements Initializable {
    ...
    public void btnAddOnAction(ActionEvent actionEvent) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/view/CoursePOPupPage.fxml"));
    ...
    public void onUpdate(CourseDTO courseDTO) {
        try {
            ...
            CoursePOPupPageController controller = fxmlLoader.getController();
